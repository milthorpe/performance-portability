...
chapel)
  ...
  append_opts "CHPL_GPU_ARCH=gfx906"
...
omp-target)
  ...
  append_opts "-DCXX_EXTRA_FLAGS=-Ofast;-fopenmp=libomp;-fopenmp-targets=amdgcn-amd-amdhsa;-Xopenmp-target=amdgcn-amd-amdhsa;-march=gfx906"
